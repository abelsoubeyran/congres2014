  	...
  	<div class="grid_24 alpha" >
  		<div class="content-bar" style="padding: 0px 20px 0px 20px;">
           ...
           <p>C'est une démarche associée au Congrès 2014 dans laquelle tu as ton rôle à jouer !<br/>
  				...
  				Comment participer ? Avec ton équipe de responsable et en lien avec tes cadres locaux et ta région, prépare un projet de service à vivre avec ton unité. L'ensemble des projets vécus un peu partout en France sera le point de départ de nos réflexions pour le Congrès.<br/><br/>

  				Tu trouveras ci-dessous :<br/>
  				- les informations pour comprendre le défi collectif que nous lançons à l'occasion du congrès<br/>
  				- les outils pour t'aider à réaliser ton projet.<br/>
  				- les grandes échéances à venir jusqu'au Congrès.<br/><br/>
...
- Pour tous : un résumé de chaque projet « 100 Ans D’Avenir à Construire » vécu en 2013-2014 dans les unités, Groupe Locaux, Régions… sera visible lors du Congrès.
          ...
          <br/><br/>
          <h5>Pour t'aider dans ton projet:</h5>
          <p> Tu dois d'abord contacter ton équipe régionale.</p>
          <p> Tu peux ensuite contacter l'équipe Congrès à l'adresse suivante: congres2014@eeudf.org</p>
